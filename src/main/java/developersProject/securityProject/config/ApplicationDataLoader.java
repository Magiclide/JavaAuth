package developersProject.securityProject.config;
...
import developersProject.securityProject.repository.PrivilegeRepository;
...
@Component
public class ApplicationDataLoader implements
